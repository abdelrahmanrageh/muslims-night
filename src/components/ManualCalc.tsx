                ...
                <form dir='ltr' className="max-w-[20rem] mx-auto grid grid-cols-2 gap-4 mt-3">
                    ...
                    <div>
                        ...
                        <div  className="relative">
                            ...
                            <input type="time" id="start-time" className="  border leading-none  text-gray-900 text-sm rounded-lg  block w-full p-2.5 bg-navy border-gray-600 placeholder-gray-400 dark:text-white"
                                min="15:00"
                                max="22:00"
